...
\node[G] at (2.2, \yg) {\sffamily \strut R\textsubscript{1}};
\node[G] at (2.2+1*\xgstep, \yg) {\sffamily \strut R\textsubscript{2}};
\node[G] at (2.2+2*\xgstep, \yg) {\sffamily \strut R\textsubscript{3}};
\node[G] at (2.2+3*\xgstep, \yg) {\sffamily \strut R\textsubscript{4}};
\node[G] at (2.2+4*\xgstep, \yg) {\sffamily \strut R\textsubscript{5}};
\node[G] at (2.2+5*\xgstep, \yg) {\sffamily \strut R\textsubscript{6}};
\node[G] at (2.2+6*\xgstep, \yg) {\sffamily \strut R\textsubscript{7}};
\node[G] at (2.2+7*\xgstep, \yg) {\sffamily \strut R\textsubscript{8}};

\node[G] at (8.05, \yg) {\sffamily \strut A\textsubscript{1}};
\node[G,align=center] at (8.05+1*\xgstep, \yg) {\sffamily \strut A\textsubscript{2}\\\sffamily \strut A\textsubscript{5}};
\node[G] at (8.05+2*\xgstep, \yg) {\sffamily \strut A\textsubscript{3}};
\node[G] at (8.05+3*\xgstep, \yg) {\sffamily \strut A\textsubscript{4}};

\node[M] at (0,0) {\includegraphics[height=7in]{mat_aml_u.png}};
\node[M] at (1.9,0) {\includegraphics[height=7in]{mat_aml_w_annotated.png}};
\node[M] at (7.75,0) {\includegraphics[height=7in]{mat_aml_v_annotated.png}};
