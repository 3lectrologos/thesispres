...
\begin{frame}{Sampling\hfill\includegraphics[width=0.6in]{figures/chapters1.pdf}}
\begin{itemize}
...
\begin{frame}{The Gibbs Sampler\hfill\includegraphics[width=0.6in]{figures/chapters1.pdf}}
\vspace{1em}
\centering
...
\begin{frame}{Polynomial-time Mixing\hfill\includegraphics[width=0.6in]{figures/chapters1.pdf}}
\vspace{0.5em}
...
\begin{frame}{Proof Outline\hfill\includegraphics[width=0.6in]{figures/chapters1.pdf}}
\vspace{0.5em}
\uncover<2->{%
...
\begin{frame}{Bottlenecks\hfill\includegraphics[width=0.6in]{figures/chapters2.pdf}}
\vspace{1em}
\centering
