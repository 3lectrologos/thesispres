...
\vspace{0.5em}
\centering
\only<1>{\includegraphics[width=\textwidth]{figures/pathways_pik3k.jpg}\\[-0.3em]
\hfill{}\qsource{biooncology.com}
}
\only<2>{\includegraphics[width=\textwidth]{figures/pathways_alt_new.png}\\[-0.3em]
...
\vspace{1em}
\centering
\only<1>{\includegraphics[width=0.9\textwidth]{figures/bottleneck1.pdf}}%
\only<2>{\includegraphics[width=0.9\textwidth]{figures/bottleneck2.pdf}}%
\only<3>{\includegraphics[width=0.9\textwidth]{figures/bottleneck3.pdf}}%
\end{frame}
...
\only<3->{%
\begin{align*}
\ell(\btheta) &=\sum_{i=1}^N \log\left( \frac{1}{Z} \exp\big(F(D_i; \btheta)\big) \right)\\
              &=\sum_{i=1}^N F(D_i; \btheta) - N \log Z(\btheta)\\[1em]
...
\only<1>{$p(S; \btheta) = \displaystyle\frac{1}{Z(\btheta)}\exp \big( F(S; \btheta) \big)$\\[1em]}
\only<2->{$p(S; \*u, \*W) = \displaystyle\frac{1}{Z(\*u, \*W)}\exp \big( F(S; \*u, \*W) \big)$\\[1em]}
\uncover<3->{%
$F(S; \*u, \*W) = \displaystyle\sum_{i \in S} u_i + \displaystyle\sum_{j=1}^{L} \left(\displaystyle\max_{i \in S} w_{ij} - \displaystyle\sum_{i \in S} w_{ij}\right),\ \ \ \*u \in \mathbb{R}^n, \*W \in \mathbb{R}_{\geq 0}^{n \times L}$
}
...
\centering
\only<1-4>{\includegraphics[height=1.4in]{figures/flid_empty.pdf}}%
\only<5>{\includegraphics[height=1.4in]{figures/flid.pdf}}%
\only<6>{\includegraphics[height=1.4in]{figures/flid_numbers_1.pdf}}%
\only<7>{\includegraphics[height=1.4in]{figures/flid_numbers_2.pdf}}%
\only<8>{\includegraphics[height=1.4in]{figures/flid.pdf}}%
\end{column}
\begin{column}{0.5\textwidth}
\only<8>{
...
\centering
\only<1>{\includegraphics[height=0.9\textheight]{figures/mat_syn_0.pdf}}%
\only<2>{\includegraphics[height=0.9\textheight]{figures/mat_syn_100.pdf}}%
\only<3>{\includegraphics[height=0.9\textheight]{figures/mat_syn_200.pdf}}%
\only<4>{\includegraphics[height=0.9\textheight]{figures/mat_syn_300.pdf}}%
\only<5>{\includegraphics[height=0.9\textheight]{figures/mat_syn_400.pdf}}%
\only<6>{\includegraphics[height=0.9\textheight]{figures/mat_syn_500.pdf}}%
\only<7>{\includegraphics[height=0.9\textheight]{figures/mat_syn_600.pdf}}%
\only<8>{\includegraphics[height=0.9\textheight]{figures/mat_syn_700.pdf}}%
\only<9>{\includegraphics[height=0.9\textheight]{figures/mat_syn_800.pdf}}%
\only<10>{\includegraphics[height=0.9\textheight]{figures/mat_syn_900.pdf}}%
